## Lab 2 - Create a Spring Cloud Config Server and Client

**Part 1 - Config Server:**

1. Create a new Spring Boot application.  Name the project "g2lab-2-server”, and use this value for the Artifact.  Use Jar packaging and the latest versions of Java.  Use a version of Boot > 2.0.x.   No need to select any dependencies.
...
1. Edit the main Application class (probably named G2Lab2ServerApplication).  Add the @EnableConfigServer to this class.
...
1. Add a new file to your GitHub repository called "g2lab-2-client.yml” (or g2lab-2-client.properties).  Add a key called "lucky-word" and a value of "Irish", "Rabbit's Foot", "Serendipity", or any other value of your choosing.
...
8. Run the application.  Open the URL [http://localhost:8001/g2lab-2-client/default/](http://localhost:8001/g2lab-2-client/default/).  You should see the JSON result that will actually be used by Spring.  If the server is not working, review the prior steps to find the issue before moving on.

  **Part 2 - Config Client:**

9. Create a new, separate Spring Boot application.  Use a version of Boot > 2.0.x.  Name the project "g2lab-2-client", and use this value for the Artifact.  Add the web dependency.  You can make this a JAR or WAR project, but the instructions here will assume JAR.
...
```
spring.application.name=g2lab-2-client
...
15. Create a separate file in your GitHub repository called "g2lab-2-client-northamerica.yml” (or .properties).  Populate it with the "lucky-word" key and a different value than used in the original file.
